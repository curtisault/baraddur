...
| ✗ | 72.0 | 8 | 0.0 | `TtyDisplay::run_finished` | `./src/output/display.rs:1328` |
| ✗ | 56.0 | 7 | 0.0 | `TtyDisplay::browse_redraw` | `./src/output/display.rs:1043` |
| ▲ | 28.1 | 12 | 51.9 | `TtyDisplay::redraw` | `./src/output/display.rs:732` |
| ▲ | 26.2 | 26 | 93.2 | `TtyDisplay::handle_key` | `./src/output/display.rs:1425` |
...
| ▲ | 15.3 | 13 | 76.0 | `TtyDisplay::step_row` | `./src/output/display.rs:815` |
...
| ✓ | 9.7 | 4 | 29.2 | `TtyDisplay::prepare_redraw_region` | `./src/output/display.rs:561` |
| ✓ | 9.4 | 9 | 83.3 | `extract_line` | `./src/output/diagnostic.rs:45` |
| ✓ | 9.2 | 9 | 86.0 | `TtyDisplay::footer_lines` | `./src/output/display.rs:945` |
...
| ✓ | 8.0 | 8 | 100.0 | `TtyDisplay::help_modal_lines` | `./src/output/display.rs:633` |
| ✓ | 8.0 | 7 | 73.1 | `write_run_log` | `./src/lib.rs:566` |
| ✓ | 7.1 | 7 | 88.2 | `TtyDisplay::expanded_output_lines` | `./src/output/display.rs:888` |
...
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::raw_mode_on` | `./src/output/display.rs:589` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::raw_mode_off` | `./src/output/display.rs:602` |
| ✓ | 6.0 | 6 | 100.0 | `TtyDisplay::compute_lines` | `./src/output/display.rs:1001` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::step_finished` | `./src/output/display.rs:1299` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::steps_skipped` | `./src/output/display.rs:1314` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::tick` | `./src/output/display.rs:1372` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::browse_redraw_if_active` | `./src/output/display.rs:1395` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::hook_output` | `./src/output/display.rs:1401` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::hook_started` | `./src/output/display.rs:1411` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::hook_finished` | `./src/output/display.rs:1418` |
...
| ✓ | 5.2 | 5 | 80.0 | `TtyDisplay::capture_step_outputs` | `./src/output/display.rs:1126` |
...
| ✓ | 5.0 | 5 | 100.0 | `TtyDisplay::divider_styled` | `./src/output/display.rs:1100` |
...
| ✓ | 4.0 | 4 | 85.7 | `TtyDisplay::open_current_diagnostic` | `./src/output/display.rs:705` |
| ✓ | 4.0 | 4 | 100.0 | `redraw_strategy` | `./src/output/display.rs:186` |
| ✓ | 4.0 | 4 | 100.0 | `PlainDisplay::step_finished` | `./src/output/display.rs:269` |
| ✓ | 4.0 | 4 | 100.0 | `TtyDisplay::summary_line` | `./src/output/display.rs:1153` |
| ✓ | 4.0 | 4 | 100.0 | `parse` | `./src/output/diagnostic.rs:28` |
| ✓ | 3.7 | 3 | 57.1 | `App::build_display` | `./src/lib.rs:96` |
| ✓ | 3.4 | 3 | 64.7 | `run_git` | `./src/git.rs:57` |
| ✓ | 3.3 | 2 | 30.6 | `TtyDisplay::banner` | `./src/output/display.rs:1185` |
| ✓ | 3.3 | 3 | 68.8 | `TtyDisplay::with_terminal_released` | `./src/output/display.rs:612` |
| ✓ | 3.1 | 3 | 77.8 | `TtyDisplay::drop` | `./src/output/display.rs:467` |
| ✓ | 3.0 | 3 | 85.7 | `await_hook` | `./src/lib.rs:507` |
| ✓ | 3.0 | 3 | 86.0 | `TtyDisplay::run_started` | `./src/output/display.rs:1237` |
| ✓ | 3.0 | 3 | 87.5 | `apply_hook_result` | `./src/lib.rs:528` |
| ✓ | 3.0 | 3 | 92.3 | `TtyDisplay::advance_diagnostic` | `./src/output/display.rs:687` |
...
| ✓ | 3.0 | 3 | 100.0 | `TtyDisplay::visual_rows_for` | `./src/output/display.rs:542` |
...
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::index_of` | `./src/output/display.rs:1090` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::set_trigger` | `./src/output/display.rs:1181` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::step_running` | `./src/output/display.rs:1292` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::run_cancelled` | `./src/output/display.rs:1322` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::enter_browse_mode` | `./src/output/display.rs:1379` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::exit_browse_mode` | `./src/output/display.rs:1386` |
...
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::new` | `./src/output/display.rs:481` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::set_editor_spawn` | `./src/output/display.rs:530` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::term_width` | `./src/output/display.rs:534` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::term_height` | `./src/output/display.rs:551` |
...
✗ 3/149 function(s) exceed CRAP threshold 30.
