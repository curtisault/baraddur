...
| ▲ | 19.0 | 19 | 97.9 | `parse_path_line_col` | `./src/output/diagnostic.rs:79` |
| ▲ | 16.0 | 8 | 50.0 | `format_truncated_output` | `./src/output/display.rs:64` |
| ▲ | 15.4 | 13 | 75.9 | `watcher_thread` | `./src/watcher/mod.rs:30` |
| ▲ | 15.3 | 13 | 76.0 | `TtyDisplay::step_row` | `./src/output/display.rs:989` |
...
| ✓ | 9.2 | 9 | 87.5 | `extract_line` | `./src/output/diagnostic.rs:45` |
...
| ✓ | 8.0 | 8 | 100.0 | `TtyDisplay::help_modal_lines` | `./src/output/display.rs:803` |
| ✓ | 8.0 | 8 | 100.0 | `TtyDisplay::run_finished` | `./src/output/display.rs:1604` |
| ✓ | 8.0 | 8 | 100.0 | `matches_filters` | `./src/watcher/mod.rs:105` |
| ✓ | 7.6 | 5 | 52.9 | `try_clipboard_command` | `./src/output/display.rs:526` |
| ✓ | 7.2 | 7 | 82.9 | `TtyDisplay::footer_lines` | `./src/output/display.rs:1119` |
| ✓ | 7.1 | 7 | 88.2 | `TtyDisplay::expanded_output_lines` | `./src/output/display.rs:1062` |
| ✓ | 7.0 | 7 | 91.4 | `not_found_error` | `./src/config/mod.rs:138` |
| ✓ | 7.0 | 7 | 100.0 | `load_from` | `./src/config/mod.rs:95` |
| ✓ | 7.0 | 7 | 100.0 | `combine_failed_output` | `./src/pipeline/hook.rs:17` |
| ✓ | 7.0 | 5 | 57.1 | `run_init` | `./src/main.rs:300` |
| ✓ | 6.3 | 5 | 62.5 | `Cli::verbosity` | `./src/main.rs:126` |
| ✓ | 6.0 | 6 | 95.2 | `TtyDisplay::clipboard_text_for_failed` | `./src/output/display.rs:681` |
| ✓ | 6.0 | 2 | 0.0 | `PlainDisplay::run_cancelled` | `./src/output/display.rs:296` |
| ✓ | 6.0 | 2 | 0.0 | `default_clipboard_writer` | `./src/output/display.rs:583` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::raw_mode_on` | `./src/output/display.rs:759` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::raw_mode_off` | `./src/output/display.rs:772` |
| ✓ | 6.0 | 6 | 100.0 | `TtyDisplay::compute_lines` | `./src/output/display.rs:1169` |
| ✓ | 6.0 | 6 | 100.0 | `TtyDisplay::viewport_slice` | `./src/output/display.rs:1232` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::steps_skipped` | `./src/output/display.rs:1590` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::tick` | `./src/output/display.rs:1648` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::browse_redraw_if_active` | `./src/output/display.rs:1671` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::hook_output` | `./src/output/display.rs:1677` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::hook_started` | `./src/output/display.rs:1687` |
| ✓ | 6.0 | 2 | 0.0 | `TtyDisplay::hook_finished` | `./src/output/display.rs:1694` |
...
| ✓ | 5.0 | 5 | 95.2 | `TtyDisplay::capture_step_outputs` | `./src/output/display.rs:1400` |
| ✓ | 5.0 | 5 | 100.0 | `ValidationErrors::fmt` | `./src/config/validate.rs:8` |
| ✓ | 5.0 | 5 | 100.0 | `strip_ansi` | `./src/output/style.rs:112` |
| ✓ | 5.0 | 5 | 100.0 | `TtyDisplay::browse_redraw` | `./src/output/display.rs:1272` |
| ✓ | 5.0 | 5 | 100.0 | `TtyDisplay::divider_styled` | `./src/output/display.rs:1374` |
...
| ✓ | 3.3 | 2 | 30.6 | `TtyDisplay::banner` | `./src/output/display.rs:1460` |
| ✓ | 3.3 | 3 | 66.7 | `TtyDisplay::drop` | `./src/output/display.rs:594` |
| ✓ | 3.3 | 3 | 68.8 | `TtyDisplay::with_terminal_released` | `./src/output/display.rs:782` |
| ✓ | 3.1 | 3 | 80.0 | `log_run_outcome` | `./src/lib.rs:658` |
| ✓ | 3.0 | 3 | 83.3 | `TtyDisplay::visual_rows_for` | `./src/output/display.rs:712` |
| ✓ | 3.0 | 3 | 85.7 | `await_hook` | `./src/lib.rs:561` |
| ✓ | 3.0 | 3 | 86.4 | `TtyDisplay::run_started` | `./src/output/display.rs:1512` |
| ✓ | 3.0 | 3 | 87.5 | `apply_hook_result` | `./src/lib.rs:582` |
| ✓ | 3.0 | 3 | 92.3 | `TtyDisplay::advance_diagnostic` | `./src/output/display.rs:861` |
...
| ✓ | 3.0 | 3 | 100.0 | `TtyDisplay::clamp_scroll` | `./src/output/display.rs:1210` |
...
| ✓ | 2.0 | 1 | 0.0 | `native_clipboard_copy` | `./src/output/display.rs:560` |
| ✓ | 2.0 | 2 | 100.0 | `TtyDisplay::draw_help_modal_overlay` | `./src/output/display.rs:1323` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::step_running` | `./src/output/display.rs:1568` |
| ✓ | 2.0 | 2 | 100.0 | `TtyDisplay::step_finished` | `./src/output/display.rs:1575` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::run_cancelled` | `./src/output/display.rs:1598` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::enter_browse_mode` | `./src/output/display.rs:1655` |
| ✓ | 2.0 | 1 | 0.0 | `TtyDisplay::exit_browse_mode` | `./src/output/display.rs:1662` |
| ✓ | 2.0 | 2 | 100.0 | `truncate_capture` | `./src/pipeline/step.rs:78` |
...
| ✓ | 1.0 | 1 | 100.0 | `Theme::cyan_underline` | `./src/output/style.rs:81` |
...
| ✓ | 1.0 | 1 | 100.0 | `osc52_sequence` | `./src/output/display.rs:518` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::new` | `./src/output/display.rs:608` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::set_editor_spawn` | `./src/output/display.rs:660` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::set_clipboard_writer` | `./src/output/display.rs:666` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::clipboard_text_for_cursor` | `./src/output/display.rs:672` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::term_width` | `./src/output/display.rs:704` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::term_height` | `./src/output/display.rs:721` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::index_of` | `./src/output/display.rs:1364` |
| ✓ | 1.0 | 1 | 100.0 | `TtyDisplay::set_trigger` | `./src/output/display.rs:1456` |
